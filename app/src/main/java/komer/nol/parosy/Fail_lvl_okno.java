...
public class Fail_lvl_okno extends AppCompatActivity {
    MediaPlayer player;
...
// кнопки меню паузы
        ...
        resum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intant = new Intent(Fail_lvl_okno.this, Tutorial.class);
        ...
        esc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intant = new Intent(Fail_lvl_okno.this, Levels.class);
                startActivity(intant); finish();
            }
        });
...
// опять же на весь экран
    ...
    public void onBackPressed(){
        try{
            player.stop();
            Intent intant = new Intent(Fail_lvl_okno.this, MainActivity.class);
            startActivity(intant); finish();
        }catch (Exception e){}
    }
}
